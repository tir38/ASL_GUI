...
% update rectangle
expandedBoundingBox(1) = expandedBoundingBox(1) + round(u);
expandedBoundingBox(3) = expandedBoundingBox(3) + round(u);
expandedBoundingBox(2) = expandedBoundingBox(2) + round(v);
expandedBoundingBox(4) = expandedBoundingBox(4) + round(v);

function varargout = ASL_GUI_TRAIN(varargin)
...
% set video format based on computer being used
if strcmp('YUY',videoFormat(1:3))==1%jvf2
  videoFormat = 'YUY2_640x480'; % justin's PC
elseif strcmp('MJP',videoFormat(1:3))==1 %jason's PC
        videoFormat = 'MJPG_640x480';
else
    display('Error: Review set video format section');
    %currently setup for justin or jasons computer only
end
